...
public class _1_IncidentLogin extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
        ...
        ((Button)ll.findViewById(R.id.loginbutton)).setOnClickListener(this);
        ((Button)ll.findViewById(R.id.guestbutton)).setOnClickListener(this);
    ...
    public void onClick(View v) {
       Toast.makeText(this.ll.getContext(), "Das ist das zweite Fragment", Toast.LENGTH_SHORT).show();
        ...
        else if(v.getResources().getResourceName(v.getId()).substring(30).contentEquals("id/guestbutton") ){
            Toast.makeText(this.ll.getContext(), "Gastzugang", Toast.LENGTH_SHORT).show();
